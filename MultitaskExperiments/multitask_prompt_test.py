...
model = DistilBertForQuestionAnswering.from_pretrained("/home/ssaxen18/Thesis/prompt_tuning/multitask_model_prompt/")
model.eval()
model.to(device)
...
directory = '/home/ssaxen18/Thesis/prompt_tuning/'

#Prompt
prompt_filename = directory + 'prompt.tsv'
...
print('Prompt: ',prompt)
# Read the data
filename = '/home/ssaxen18/Thesis/prompt_tuning/qa_dataset_v2/1_test_file.tsv'
...
print("EM Score: {0:.2f}".format(avg_test_accuracy))
